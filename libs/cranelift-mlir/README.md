...
```bash
ELODIN_BACKEND=cranelift ELODIN_CRANELIFT_DUMP_DIR=/tmp/dump \
...
1. Generate a checkpoint:
   ```bash
   ELODIN_BACKEND=cranelift ELODIN_CRANELIFT_CHECKPOINT_DIR=/tmp/ckpt \
